			    ...
			    <div class="card">
		        	...
		        	<div class="card-body card-block">
		                ...
		                <div class="row form-group">
		                    ...
		                    <div class="col-12 col-md-9">
		                        <input name="masa_kerja" type="text" class="form-control" value="<?php echo $pecah["masa_kerja"]; ?>"<?php echo $r; ?>>
		                    </div>
		                </div>
		                <div class="row form-group">
		                    <div class="col col-md-3">
...
<?php 
	...
	{
		$koneksi -> query("UPDATE pembimbing SET username = '$_POST[username]' , password = '$_POST[password]' , nama_lengkap = '$_POST[nama]' , jenis_kelamin = '$_POST[jenis_kelamin]' , jabatan = '$_POST[jabatan]' , pddk_terakhir = '$_POST[pen_terakhir]' , masa_kerja = '$_POST[masa_kerja]' , alamat = '$_POST[alamat]' , no_telepon = '$_POST[no_telepon]' WHERE id_pembimbing = '$_GET[id]'");
