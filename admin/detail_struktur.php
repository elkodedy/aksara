<?php  
	...
	$ambil = $koneksi -> query("SELECT * FROM struktur_lembaga WHERE id_struktur = '$_GET[id]'");
			...
			<div class="col-lg-12">
			    ...
			    <div class="card">
		        	...
		        	<div class="card-body card-block">
		                ...
		                <div class="row form-group">
		                    <div class="col col-md-3">
		                        <label for="email-input" class=" form-control-label">Ganti Foto</label>
		                    </div>
		                    <div class="col-12 col-md-9">
...
<?php 
	...
	{
		$koneksi -> query("UPDATE struktur_lembaga SET username = '$_POST[username]' , password = '$_POST[password]' , nama_lengkap = '$_POST[nama]' , jenis_kelamin = '$_POST[jenis_kelamin]' , jabatan = '$_POST[jabatan]' , pddk_terakhir = '$_POST[pen_terakhir]' , alamat = '$_POST[alamat]' , no_telepon = '$_POST[no_telepon]' WHERE id_struktur = '$_GET[id]'");
