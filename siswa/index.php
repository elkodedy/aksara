...
<?php 
    ...
    $ambil = $koneksi -> query("SELECT * FROM siswa WHERE id_siswa = '$id'");
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="sideBar">
                            <a href="index.php?halaman=lembar_penilaian">
                            <i class="fas fa-graduation-cap"></i>Lembar Penilaian</a>
                        </li>
                    </ul>
                </div>
            </nav>
                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="../img/<?php echo $pecah['foto'] ?>"/>
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"><?php echo $_SESSION['siswa']['nama_lengkap'] ?></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#"><?php echo $_SESSION['siswa']['nama_lengkap'] ?></a>
                                                    </h5>
                                                    <span class="email"><?php echo $pecah['username']; ?></span>
                                                </div>
                                            </div>
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        if (isset($_GET['halaman'])) 
                        {
                            ...
                            elseif ($_GET['halaman']=="lembar_penilaian") 
                            {
                                include 'lembar_penilaian.php';
                            }
                        }
                        else
                        {
