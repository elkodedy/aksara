		        ...
		        <div class="card-body card-block">
		            ...
		            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
		                ...
		                <div class="row form-group">
		                    ...
		                    <div class="col-12 col-md-9">
		                        <input type="email" class="form-control" readonly value="<?php echo $pecah["nama_ibu"]; ?>">
		                    </div>
		                </div>
		                <div class="row form-group">
		                    <div class="col col-md-3">
		                ...
		                <div class="row form-group">
		                    ...
		                    <div class="col-12 col-md-9">
		                        <input type="email" class="form-control" readonly value="<?php echo $pecah["usia"]; ?>">
		                    </div>
	                    </div>
		                <div class="row form-group">
		                    <div class="col col-md-3">
		                    ...
		                    <div class="col-12 col-md-9">
		                        <input type="email" class="form-control" readonly value="<?php echo $pecah["tgl_masuk"]; ?>">
		                    </div>
		                </div>
		                <div class="row form-group">
		                    <div class="col col-md-3">
		                    ...
		                    <div class="col-12 col-md-9">
		                        <input type="email" class="form-control" readonly value="<?php echo $pecah["alamat"]; ?>">
		                    </div>
		                </div>
		                <div class="row form-group">
		                    <div class="col col-md-3">
		                    ...
		                    <div class="col-12 col-md-9">
		                        <input type="email" class="form-control" readonly value="<?php echo $pecah["kontak"]; ?>">
		                    </div>
		                </div>
		            </form>
		        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
						<select class="form-control" name="tanggal" required>
		                	...
		                	<?php
		                		$pnddik = $_SESSION['pendidik']['id_pendidik'];
		                		$ambil = $koneksi -> query("
		                			SELECT pt.tanggal
									FROM program_aba pr, peserta pt, jadwal_terapi jt, pendidik pk
									WHERE pr.id_program=jt.id_program and pt.id_jadwal=jt.id_jadwal and pt.id_siswa='$_GET[id]' and pr.nama_program='Perilaku Dan Kontak Mata' and pk.id_pendidik=jt.id_pendidik and jt.id_pendidik='$id'
									GROUP BY pt.tanggal
		                		");
		                	?>
		                	<?php 
